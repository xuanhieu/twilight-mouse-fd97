...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-mouse-fd97
```

A live public deployment of this template is available at [https://twilight-mouse-fd97.templates.workers.dev](https://twilight-mouse-fd97.templates.workers.dev)
